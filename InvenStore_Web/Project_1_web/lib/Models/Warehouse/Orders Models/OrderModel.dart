...
class OrderModel {
  ...
  factory OrderModel.fromjson(jsonData) {
    return OrderModel(
      ...
      orderCost: jsonData['order_cost'],
      shippingCost: jsonData['shipping_cost'],
      totalCost: jsonData['total_cost'],
      buyOrdersUpdate: jsonData['buy_orders_update'],
    );
  }
}
