...
class SearchDialog {
  Future<Map<String, dynamic>> orderFilterDialog(
  ...
  Future<Map<String, dynamic>> productsFilterDialog(BuildContext context,
      {required bool isAll}) async {
    Map<String, dynamic> data = {
      'name': null,
      'manufacturer': null,
      'category': null,
    ...
    final TextEditingController moreExpensiveThancostController =
        TextEditingController();
    List<String> status = [S().valid, S().expired];
