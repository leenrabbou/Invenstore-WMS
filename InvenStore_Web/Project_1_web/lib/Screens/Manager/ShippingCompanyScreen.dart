...
import 'package:buymore/Screens/Manager/SearchShippingCompanyScreen.dart';
...
import 'package:buymore/helper/Manager/Shipping%20Company/ShippingCompanyContainer.dart';
...
class ShippingCompanyScreen extends StatefulWidget {
  const ShippingCompanyScreen({super.key});

  @override
  State<ShippingCompanyScreen> createState() => _ShippingCompanyScreenState();
}

class _ShippingCompanyScreenState extends State<ShippingCompanyScreen> {
  final TextEditingController _searchController = TextEditingController();

  List<ManufacturerModel> shippingCompanyList = [];
  ...
  Future<void> _onRefresh() async {
    ...
    try {
      final newData = await ShippingCompanyServices()
          .showAllShippingCompaniesService(null, locale);
      setState(() {
        shippingCompanyList = newData.data;
      });
    } catch (e) {
      if (kDebugMode) {
        print(e.toString());
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (BuildContext context) {
                    return SearchShippingCompanyScreen(
        ...
        actions: [
          permissionsMap['shippingCompany.store'] == false
              ...
              : Padding(
                  ...
                  child: TextButton(
                    ...
                    child: Text(
                      S.of(context).addShippingCompany,
                      style: TextStyle(
          ...
          children: [
            ...
            Expanded(
              child: FutureBuilder<ManufacturerRequestModel>(
                  future: ShippingCompanyServices()
                      .showAllShippingCompaniesService(null, locale),
                      ...
                      if (snapshot.hasData) {
                        ...
                        return LiquidPullToRefresh(
                          ...
                          child: ListView.builder(
                              itemCount: shippingCompanyList.length,
                              itemBuilder: (BuildContext context, int index) {
                                return ShippingCompanyContainer(
                                  shippingCompany: shippingCompanyList[index],
                                );
                              }),
                        );
