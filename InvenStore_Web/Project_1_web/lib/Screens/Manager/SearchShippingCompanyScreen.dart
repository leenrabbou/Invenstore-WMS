...
class SearchShippingCompanyScreen extends StatefulWidget {
  const SearchShippingCompanyScreen({super.key, required this.search});
  final String search;
  @override
  State<SearchShippingCompanyScreen> createState() =>
      _ShippingCompanyScreenState();
}

class _ShippingCompanyScreenState extends State<SearchShippingCompanyScreen> {
            ...
            Expanded(
              child: FutureBuilder<ManufacturerRequestModel>(
                  future: ShippingCompanyServices()
                      .showAllShippingCompaniesService(widget.search, locale),
