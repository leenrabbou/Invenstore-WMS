...
import 'package:buymore/Screens/Manager/SearchProductsSubcategoryScreen.dart';
    ...
    try {
      final response = await SubcategoriesService()
          .showSubcategoriesProductsService(
              widget.subcategory.id, page, null, locale);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (BuildContext context) {
                    return SearchProductsSubCategoryScreen(
        ...
        actions: [
          permissionsMap['product.store'] == false
          ...
          permissionsMap['category.update'] == false
              ? const SizedBox.shrink()
              : Padding(
                  padding: EdgeInsets.only(
                      top: 10.0,
