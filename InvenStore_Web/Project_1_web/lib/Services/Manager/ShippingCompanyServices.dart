...
List<ManufacturerModel> allShippingCompaniesList = [];

class ShippingCompanyServices {
  Future<ManufacturerRequestModel> showAllShippingCompaniesService(
      String? search, Locale locale) async {
    String url;
    search == null
        ? url = 'shipping-companies'
        : url = 'shipping-companies?search=$search';
  ...
  Future<dynamic> addShippingCompanyService(String nameEn, String nameAr,
      String stateId, String streetEn, String streetAr, Locale locale) async {
    var response =
        await http.post(Uri.parse('$basicurl/shipping-companies'), headers: {
      'Authorization': 'Bearer $token',
      'locale': locale.languageCode
    }, body: {
      'name_en': nameEn,
  ...
  Future<dynamic> editShippingCompanyService(
      String? nameEn,
      String? nameAr,
      int? stateId,
      String? streetEn,
      ...
      int id,
      Locale locale) async {
    var uri = Uri.parse('$basicurl/shipping-companies/$id');
