...
import 'package:buymore/Models/Manager/Employee/EmployeeRequestModel.dart';
...
class EmployeesServices {
  ...
  Future<dynamic> editEmployeeService(
    ...
    if (password.toString().isNotEmpty && password != null) {
      request.fields['password'] = password;
    }
    ...
    if (roleId.toString().isNotEmpty && roleId != null) {
      request.fields['role_id'] = roleId.toString();
    }
    if (employeableType.toString().isNotEmpty && employeableType != null) {
      request.fields['employable_type'] = employeableType;
    }
    if (employeableId.toString().isNotEmpty && employeableId != null) {
      request.fields['employable_id'] = employeableId.toString();
    }
    if (employable.toString().isNotEmpty && employable != null) {
      request.fields['employable'] = employable;
    }
    if (ssn.toString().isNotEmpty && ssn != null) {
      request.fields['ssn'] = ssn;
    }
  ...
  Future<AnEmployeeModel> banEmployeesService(
      int id, String? expiredAt, Locale locale) async {
    String url;
    expiredAt == null
        ? url = 'employees/$id/ban'
        : url = 'employees/2/ban?expired_at=$expiredAt';
    final http.Response res = await http.get(
    ...
    if (res.statusCode == 200) {
      Map<String, dynamic> data = json.decode(res.body);
      AnEmployeeModel s = AnEmployeeModel.fromjson(data);
  ...
  Future<AnEmployeeModel> unbanEmployeesService(int id, Locale locale) async {
    final http.Response res = await http.delete(
      Uri.parse('$basicurl/employees/$id/ban'),
      headers: {
        'Authorization': 'Bearer $token',
        'locale': locale.languageCode
      },
