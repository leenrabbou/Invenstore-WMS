...
import 'package:buymore/Models/Warehouse/AllProduct%20Model/AllProductRequestModel.dart';
import 'package:buymore/Models/Warehouse/AllProduct%20Model/AnProductAllModel.dart';
import 'package:buymore/Models/Warehouse/StoredProducts%20Models/AnStoredProductModel.dart';
import 'package:buymore/Models/Warehouse/StoredProducts%20Models/StoredProductRequestModel.dart';
...
class ProductsService {
  ...
  Future<AllProductRequestModel> showAllProductsService(
      int page, String? search, String? sort, Locale locale) async {
    String url;
    search == null
  ...
  Future<StoredProductRequestModel> showStoredProductsService(int page,
      String status, String? search, String? sort, Locale locale) async {
    String url;
    search == null
    ...
    if (res.statusCode == 200) {
      Map<String, dynamic> data = json.decode(res.body);
      StoredProductRequestModel response =
          StoredProductRequestModel.fromjson(data);
      return response;
    } else {
      throw Exception('${res.statusCode} with ${res.body}');
    }
  ...
  Future<dynamic> editStoredProductService(
      int? max, int? active, int id, Locale locale) async {
