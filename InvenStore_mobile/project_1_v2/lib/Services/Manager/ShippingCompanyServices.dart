...
import 'package:project_1_v2/Models/Manager/Manufacturer/ManufacturerRequestModel.dart';
...
class ShippingCompanyServices {
  Future<ManufacturerRequestModel> showAllShippingCompaniesService(
    ...
    final http.Response res = await http.get(
      Uri.parse('$basicurl/shipping-companies'),
      headers: {
  ...
  Future<dynamic> addShippingCompanyService(
    String nameEn,
    String nameAr,
    String stateId,
    String streetEn,
