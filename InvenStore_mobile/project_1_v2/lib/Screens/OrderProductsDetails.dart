...
class OrderProductDetailsScreen extends StatefulWidget {
  OrderProductDetailsScreen({super.key, required this.product});
  OrderProductModel product;
  @override
  State<OrderProductDetailsScreen> createState() =>
      _ProductDetailsScreenState();
}

class _ProductDetailsScreenState extends State<OrderProductDetailsScreen> {
  @override
